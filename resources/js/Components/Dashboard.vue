...
<template>
    <div  class="" >
        <ButtonLink class="ml-3 mt-4" :href="route('dashboard')">Reservation</ButtonLink> <ButtonLink class="ml-3" :href="route('dashboard')">Menu</ButtonLink>
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">

            <h1 class="mt-8 text-2xl font-medium text-gray-900">
                <center>[<strong>{{ name }}</strong>] Welcome to Dashboard Admin Restaurant Dava!</center>
            </h1>

            <p class="mt-6 text-gray-500 leading-relaxed"><center>
               ...
               <h2><strong>~SELAMAT BEKERJA ADMIN RESTORAN DAVA~</strong></h2></center> 
            </p>
        </div>
